...
![Checkmate in action, checkmating its opponent](checkmate.png)

## What is this?

Checkmate is an UCI (Universal Chess Interface) compatible chess engine written from scratch in C++. It utilizes various techniques and uniquely integrates them to maximize the engine's performance. These techniques include:
